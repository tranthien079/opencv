...
mydb = mysql.connector.connect(
    ...
    user="if0_36740907",
    passwd="S2saPAnFGZvYEP",
    database="if0_36740907_smarth"
)
...
def generate_dataset(nbr):
    face_classifier = cv2.CascadeClassifier("D:/hk9/pythonProject/resources/haarcascade_frontalface_default.xml")
...
def train_classifier(nbr):
    dataset_dir = "D:/hk9/pythonProject/dataset"
...
def face_recognition():  # generate frame by frame from camera
    ...
    faceCascade = cv2.CascadeClassifier("D:/hk9/pythonProject/resources/haarcascade_frontalface_default.xml")
    clf = cv2.face.LBPHFaceRecognizer_create()
